...
async def lvl(interaction: discord.Interaction, user: discord.Member):
    with open('/home/leon/PythonScripts/BobV2/BobV2/levels.json', 'r') as levels:
        ...
        for auramonster in data.keys():
            if 'txp' in data[auramonster] and 'txp' in userdata and 'vxp' in data[auramonster] and 'vxp' in userdata:
        ...
        format = discord.Embed(colour=discord.Color.gold(), title=f"{user.display_name}'s Rankings", type='rich', description='')
